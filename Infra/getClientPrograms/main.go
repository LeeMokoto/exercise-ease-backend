...
import (
	"encoding/json"
	"getClientPrograms/main/pkg/db"
	inputModel "getClientPrograms/main/pkg/input"
	programModel "getClientPrograms/main/pkg/program"
	"net/http"
...
func handler(req events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse, error) {
	...
	result := db2.Model(&programModel.Program{}).Preload("Exercises").Find(&programs, "client_id = ?", id.ClientId)
